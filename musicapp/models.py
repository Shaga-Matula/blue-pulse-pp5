...
class CommentMod(models.Model):
    ...
    music = models.ForeignKey(MusicMod, on_delete=models.CASCADE,
    ...
    reply_to = models.ForeignKey(UserProfile,
                                 on_delete=models.SET_NULL,
                                 null=True, blank=True, related_name='replies')

    def __str__(self):
        user = self.user_profile.user
        return (f"Comment by {user.username} on {self.music.artist_name} - , \
        {self.music.song_title}")
